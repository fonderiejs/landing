...
export default function Solution() {
  ...
  const config = `// fonderie.config.ts — generated by your AI
...
export default defineApp({
  ...
  const productLogic = `// product logic — you write this part
    ...
    <section className="solution">
      ...
      <div className="solution__grid">
        ...
        <div className="solution__panel">
          ...
          <div className="solution__code">
            <CodeBlock code={`$ npx @fonderie/create my-saas\n# dependencies installed, modules registered, project scaffolded`} lang="bash" />
          </div>
